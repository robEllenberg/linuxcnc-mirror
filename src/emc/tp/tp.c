...
STATIC int tpGetMachineAccelBounds(PmCartesian  * const acc_bound) {
    ...
    acc_bound->x = emcmotDebug->axes[0].acc_limit;
    acc_bound->y = emcmotDebug->axes[1].acc_limit;
    acc_bound->z = emcmotDebug->axes[2].acc_limit;
    return TP_ERR_OK;
}
...
STATIC int tpGetMachineVelBounds(PmCartesian  * const vel_bound) {
    ...
    vel_bound->x = emcmotDebug->axes[0].vel_limit;
    vel_bound->y = emcmotDebug->axes[1].vel_limit;
    vel_bound->z = emcmotDebug->axes[2].vel_limit;
    return TP_ERR_OK;
}
